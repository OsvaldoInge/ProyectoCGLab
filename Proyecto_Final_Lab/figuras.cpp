...
void CFiguras::prisma3(GLuint textura1, GLuint textura2, float u, float v)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(u, 0.0f); glVertex3fv(vertice[0]);
...
void CFiguras::plano(GLuint textura2, float u, float v)  //Funcion creacion plano
{
	GLfloat vertice[4][3] = {
				{0.0 ,0.0, 0.0},    //Coordenadas Vértice 0 V0
				{0.0 ,1.0, 0.0},    //Coordenadas Vértice 1 V1
				{1.0 ,0.0, 0.0},    //Coordenadas Vértice 2 V2
				{1.0 ,1.0, 0.0},    //Coordenadas Vértice 3 V3

	};


	glBindTexture(GL_TEXTURE_2D, textura2);   // choose the texture to use.
	glBegin(GL_POLYGON);	//inf_der
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, v); glVertex3fv(vertice[1]);
	glTexCoord2f(u, v); glVertex3fv(vertice[3]);
	glTexCoord2f(u, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
...
void CFiguras::techo(GLuint textura2) {
	GLfloat vertice[5][3] = {
				{0.0 ,0.0, 0.0},    //Coordenadas Vértice 0 V0
				{1.0 ,1.0, -1.0},    //Coordenadas Vértice 1 V1
				{2.0 ,0.0, 0.0},    //Coordenadas Vértice 2 V2
	...
	glBindTexture(GL_TEXTURE_2D, textura2);   // choose the texture to use.
	glBegin(GL_TRIANGLE_FAN);	//inf_der
	glNormal3f(0.0f, 0.0f, -1.0f);
